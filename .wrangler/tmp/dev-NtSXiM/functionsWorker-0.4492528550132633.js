...
// .wrangler/tmp/pages-JOrNq5/functionsWorker-0.4492528550132633.mjs
...
var __export = /* @__PURE__ */ __name2((target, all) => {
  for (var name in all)
    __defProp22(target, name, {
      ...
      enumerable: true,
      configurable: true,
      set: /* @__PURE__ */ __name2((newValue) => all[name] = () => newValue, "set")
    });
}, "__export");
...
__name2(createSubjects, "createSubjects");
...
__export(exports_errors, {
  JWTInvalid: /* @__PURE__ */ __name2(() => JWTInvalid, "JWTInvalid"),
  JWTExpired: /* @__PURE__ */ __name2(() => JWTExpired, "JWTExpired"),
  JWTClaimValidationFailed: /* @__PURE__ */ __name2(() => JWTClaimValidationFailed, "JWTClaimValidationFailed"),
  JWSSignatureVerificationFailed: /* @__PURE__ */ __name2(() => JWSSignatureVerificationFailed, "JWSSignatureVerificationFailed"),
  JWSInvalid: /* @__PURE__ */ __name2(() => JWSInvalid, "JWSInvalid"),
  JWKSTimeout: /* @__PURE__ */ __name2(() => JWKSTimeout, "JWKSTimeout"),
  JWKSNoMatchingKey: /* @__PURE__ */ __name2(() => JWKSNoMatchingKey, "JWKSNoMatchingKey"),
  JWKSMultipleMatchingKeys: /* @__PURE__ */ __name2(() => JWKSMultipleMatchingKeys, "JWKSMultipleMatchingKeys"),
  JWKSInvalid: /* @__PURE__ */ __name2(() => JWKSInvalid, "JWKSInvalid"),
  JWKInvalid: /* @__PURE__ */ __name2(() => JWKInvalid, "JWKInvalid"),
  JWEInvalid: /* @__PURE__ */ __name2(() => JWEInvalid, "JWEInvalid"),
  JWEDecryptionFailed: /* @__PURE__ */ __name2(() => JWEDecryptionFailed, "JWEDecryptionFailed"),
  JOSENotSupported: /* @__PURE__ */ __name2(() => JOSENotSupported, "JOSENotSupported"),
  JOSEError: /* @__PURE__ */ __name2(() => JOSEError, "JOSEError"),
  JOSEAlgNotAllowed: /* @__PURE__ */ __name2(() => JOSEAlgNotAllowed, "JOSEAlgNotAllowed")
});
...
var epoch_default = /* @__PURE__ */ __name2((date) => Math.floor(date.getTime() / 1e3), "epoch_default");
var minute = 60;
var hour = minute * 60;
var day = hour * 24;
var week = day * 7;
...
var jwt_claims_set_default = /* @__PURE__ */ __name2((protectedHeader, encodedPayload, options = {}) => {
  ...
  const { requiredClaims = [], issuer, subject: subject2, audience, maxTokenAge } = options;
...
var InvalidSubjectError = class extends Error {
  ...
  static {
    __name2(this, "InvalidSubjectError");
  }
  constructor() {
...
var InvalidRefreshTokenError = class extends Error {
  ...
  static {
    __name2(this, "InvalidRefreshTokenError");
  }
  constructor() {
...
var InvalidAccessTokenError = class extends Error {
  ...
  static {
    __name2(this, "InvalidAccessTokenError");
  }
  constructor() {
...
var InvalidAuthorizationCodeError = class extends Error {
  ...
  static {
    __name2(this, "InvalidAuthorizationCodeError");
  }
  constructor() {
...
__name2(generateVerifier, "generateVerifier");
...
var createClient2 = /* @__PURE__ */ __name2(({
  clientID,
  issuer
}) => createClient({
  clientID,
...
__name2(getGlobalConfig, "getGlobalConfig");
var store$3;
function getGlobalMessage(lang) {
  return store$3?.get(lang);
}
__name(getGlobalMessage, "getGlobalMessage");
__name2(getGlobalMessage, "getGlobalMessage");
var store$2;
function getSchemaMessage(lang) {
  return store$2?.get(lang);
}
__name(getSchemaMessage, "getSchemaMessage");
__name2(getSchemaMessage, "getSchemaMessage");
var store$1;
function getSpecificMessage(reference, lang) {
  return store$1?.get(reference)?.get(lang);
}
__name(getSpecificMessage, "getSpecificMessage");
__name2(getSpecificMessage, "getSpecificMessage");
...
var Column = class {
  ...
  constructor(table3, config22) {
    this.table = table3;
    this.config = config22;
    this.name = config22.name;
    this.keyAsName = config22.keyAsName;
    this.notNull = config22.notNull;
    this.default = config22.default;
    this.defaultFn = config22.defaultFn;
    this.onUpdateFn = config22.onUpdateFn;
    this.hasDefault = config22.hasDefault;
    this.primary = config22.primaryKey;
    this.isUnique = config22.isUnique;
    this.uniqueName = config22.uniqueName;
    this.uniqueType = config22.uniqueType;
    this.dataType = config22.dataType;
    this.columnType = config22.columnType;
    this.generated = config22.generated;
    this.generatedIdentity = config22.generatedIdentity;
  }
...
var PgColumn = class extends Column {
  ...
  constructor(table3, config22) {
    if (!config22.uniqueName) {
      config22.uniqueName = uniqueKeyName(table3, [config22.name]);
    }
    super(table3, config22);
    this.table = table3;
  }
...
var tracer = {
  startActiveSpan(name, fn) {
    ...
    if (!rawTracer) {
      rawTracer = otel.trace.getTracer("drizzle-orm", version22);
    }
...
var SQL = class _SQL {
  ...
  toQuery(config22) {
    return tracer.startActiveSpan("drizzle.buildSQL", (span) => {
      const query = this.buildQueryFromSourceParams(this.queryChunks, config22);
      span?.setAttributes({
  ...
  buildQueryFromSourceParams(chunks, _config) {
    const config22 = Object.assign({}, _config, {
    ...
    return mergeQueries(chunks.map((chunk) => {
      ...
      if (Array.isArray(chunk)) {
        ...
        result.push(new StringChunk(")"));
        return this.buildQueryFromSourceParams(result, config22);
      }
      if (is(chunk, _SQL)) {
      ...
      if (is(chunk, Param)) {
        ...
        if (is(mappedValue, _SQL)) {
          return this.buildQueryFromSourceParams([mappedValue], config22);
        }
        if (inlineParams) {
          return { sql: this.mapInlineParam(mappedValue, config22), params: [] };
        }
        let typings = ["none"];
        if (prepareTyping) {
      ...
      if (isSQLWrapper(chunk)) {
        if (chunk.shouldOmitSQLParens?.()) {
          return this.buildQueryFromSourceParams([chunk.getSQL()], config22);
        }
        return this.buildQueryFromSourceParams([
          new StringChunk("("),
          chunk.getSQL(),
      ...
      if (inlineParams) {
        return { sql: this.mapInlineParam(chunk, config22), params: [] };
      }
      return { sql: escapeParam(paramStartIndex.value++, chunk), params: [chunk], typings: ["none"] };
    }));
  }
...
var ForeignKeyBuilder = class {
  ...
  _onUpdate;
  _onDelete;
  constructor(config22, actions) {
    this.reference = () => {
      const { name, columns, foreignColumns } = config22();
...
__name2(uniqueKeyName2, "uniqueKeyName2");
var SQLiteColumnBuilder = class extends ColumnBuilder {
  ...
  generatedAlwaysAs(as, config22) {
    this.config.generated = {
      as,
      type: "always",
      mode: config22?.mode ?? "virtual"
    };
    return this;
  }
...
var SQLiteColumn = class extends Column {
  ...
  constructor(table3, config22) {
    if (!config22.uniqueName) {
      config22.uniqueName = uniqueKeyName2(table3, [config22.name]);
    }
    super(table3, config22);
    this.table = table3;
  }
...
function blob(a, b) {
  const { name, config: config22 } = getColumnNameAndConfig(a, b);
  if (config22?.mode === "json") {
    return new SQLiteBlobJsonBuilder(name);
  }
  if (config22?.mode === "bigint") {
...
var SQLiteCustomColumn = class extends SQLiteColumn {
  ...
  constructor(table3, config22) {
    super(table3, config22);
    this.sqlName = config22.customTypeParams.dataType(config22.fieldConfig);
    this.mapTo = config22.customTypeParams.toDriver;
    this.mapFrom = config22.customTypeParams.fromDriver;
  }
  getSQLType() {
    return this.sqlName;
  }
...
function customType(customTypeParams) {
  return (a, b) => {
    const { name, config: config22 } = getColumnNameAndConfig(a, b);
    return new SQLiteCustomColumnBuilder(name, config22, customTypeParams);
  };
}
...
function integer(a, b) {
  const { name, config: config22 } = getColumnNameAndConfig(a, b);
  if (config22?.mode === "timestamp" || config22?.mode === "timestamp_ms") {
    return new SQLiteTimestampBuilder(name, config22.mode);
  }
  if (config22?.mode === "boolean") {
    return new SQLiteBooleanBuilder(name, config22.mode);
  }
...
var SQLiteTextBuilder = class extends SQLiteColumnBuilder {
  ...
  constructor(name, config22) {
    super(name, "string", "SQLiteText");
    this.config.enumValues = config22.enum;
    this.config.length = config22.length;
  }
  build(table3) {
...
function text(a, b = {}) {
  ...
  return new SQLiteTextBuilder(name, config22);
}
__name(text, "text");
__name2(text, "text");
...
var One = class _One extends Relation {
  ...
  constructor(sourceTable, referencedTable, config22, isNullable) {
    super(sourceTable, referencedTable, config22?.relationName);
    this.config = config22;
...
var Many = class _Many extends Relation {
  ...
  constructor(sourceTable, referencedTable, config22) {
    super(sourceTable, referencedTable, config22?.relationName);
    this.config = config22;
  }
...
function createOne(sourceTable) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function one(table3, config22) {
    return new One(sourceTable, table3, config22, config22?.fields.reduce((res, f) => res && f.notNull, true) ?? false);
  }, "one"), "one");
}
__name(createOne, "createOne");
__name2(createOne, "createOne");
function createMany(sourceTable) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function many(referencedTable, config22) {
    return new Many(sourceTable, referencedTable, config22);
  }, "many"), "many");
}
...
var SQLiteDialect = class {
  ...
  casing;
  constructor(config22) {
    this.casing = new CasingCache(config22?.casing);
  }
  escapeName(name) {
    return `"${name}"`;
  }
    ...
    if (joins) {
      for (const [index, joinMeta] of joins.entries()) {
        ...
        if (is(table3, SQLiteTable)) {
          ...
          joinsArray.push(sql`${sql.raw(joinMeta.joinType)} join ${table3}${onSql}`);
        }
  ...
  buildSelectQuery({
    ...
    for (const f of fieldsList) {
      if (is(f.field, Column) && getTableName(f.field.table) !== (is(table3, Subquery) ? table3._.alias : is(table3, SQLiteViewBase) ? table3[ViewBaseConfig].name : is(table3, SQL) ? void 0 : getTableName(table3)) && !((table22) => joins?.some(({ alias }) => alias === (table22[Table.Symbol.IsAlias] ? getTableName(table22) : table22[Table.Symbol.BaseName])))(f.field.table)) {
  ...
  buildRelationalQuery({
    ...
    if (config22 === true) {
      ...
      if (config22.where) {
        const whereSql = typeof config22.where === "function" ? config22.where(aliasedColumns, getOperators()) : config22.where;
      ...
      if (config22.columns) {
        ...
        for (const [field, value] of Object.entries(config22.columns)) {
          if (value === void 0) {
            continue;
          }
        ...
        if (selectedColumns.length > 0) {
          selectedColumns = isIncludeMode ? selectedColumns.filter((c) => config22.columns?.[c] === true) : Object.keys(tableConfig.columns).filter((key) => !selectedColumns.includes(key));
        }
      } else {
      ...
      if (config22.with) {
        selectedRelations = Object.entries(config22.with).filter((entry) => !!entry[1]).map(([tsKey, queryConfig]) => ({ tsKey, queryConfig, relation: tableConfig.relations[tsKey] }));
      }
      let extras;
      if (config22.extras) {
        extras = typeof config22.extras === "function" ? config22.extras(aliasedColumns, { sql }) : config22.extras;
      ...
      let orderByOrig = typeof config22.orderBy === "function" ? config22.orderBy(aliasedColumns, getOrderByOperators()) : config22.orderBy ?? [];
      ...
      limit = config22.limit;
      offset = config22.offset;
      for (const {
...
var SQLiteSyncDialect = class extends SQLiteDialect {
  ...
  migrate(migrations, session, config22) {
    const migrationsTable = config22 === void 0 ? "__drizzle_migrations" : typeof config22 === "string" ? "__drizzle_migrations" : config22.migrationsTable ?? "__drizzle_migrations";
...
var SQLiteAsyncDialect = class extends SQLiteDialect {
  ...
  async migrate(migrations, session, config22) {
    const migrationsTable = config22 === void 0 ? "__drizzle_migrations" : typeof config22 === "string" ? "__drizzle_migrations" : config22.migrationsTable ?? "__drizzle_migrations";
    const migrationTableCreate = sql`
			CREATE TABLE IF NOT EXISTS ${sql.identifier(migrationsTable)} (
				id SERIAL PRIMARY KEY,
...
var SQLiteSelectBuilder = class {
  ...
  distinct;
  constructor(config22) {
    this.fields = config22.fields;
    this.session = config22.session;
    this.dialect = config22.dialect;
    this.withList = config22.withList;
    this.distinct = config22.distinct;
  }
  from(source) {
  ...
  createJoin(joinType) {
    return (table3, on22) => {
      ...
      if (typeof on22 === "function") {
        on22 = on22(new Proxy(this.config.fields, new SelectionProxyHandler({ sqlAliasedBehavior: "sql", sqlBehavior: "sql" })));
      }
      if (!this.config.joins) {
        this.config.joins = [];
      }
      this.config.joins.push({ on: on22, table: table3, joinType, alias: tableName });
...
var SQLiteSelectBase = class extends SQLiteSelectQueryBuilderBase {
  ...
  $withCache(config22) {
    this.cacheConfig = config22 === void 0 ? { config: {}, enable: true, autoInvalidate: true } : config22 === false ? { enable: false } : { enable: true, autoInvalidate: true, ...config22 };
    return this;
  }
  prepare() {
    return this._prepare(false);
...
var SQLiteInsertBase = class extends QueryPromise {
  ...
  onConflictDoNothing(config22 = {}) {
    if (!this.config.onConflict)
      this.config.onConflict = [];
    if (config22.target === void 0) {
      this.config.onConflict.push(sql` on conflict do nothing`);
    } else {
      const targetSql = Array.isArray(config22.target) ? sql`${config22.target}` : sql`${[config22.target]}`;
      const whereSql = config22.where ? sql` where ${config22.where}` : sql``;
      this.config.onConflict.push(sql` on conflict ${targetSql} do nothing${whereSql}`);
    }
    return this;
  }
  onConflictDoUpdate(config22) {
    if (config22.where && (config22.targetWhere || config22.setWhere)) {
      throw new Error('You cannot use both "where" and "targetWhere"/"setWhere" at the same time - "where" is deprecated, use "targetWhere" or "setWhere" instead.');
    }
    if (!this.config.onConflict)
      this.config.onConflict = [];
    const whereSql = config22.where ? sql` where ${config22.where}` : void 0;
    const targetWhereSql = config22.targetWhere ? sql` where ${config22.targetWhere}` : void 0;
    const setWhereSql = config22.setWhere ? sql` where ${config22.setWhere}` : void 0;
    const targetSql = Array.isArray(config22.target) ? sql`${config22.target}` : sql`${[config22.target]}`;
    const setSql = this.dialect.buildUpdateSet(this.config.table, mapUpdateSet(this.config.table, config22.set));
  ...
  createJoin(joinType) {
    return (table3, on22) => {
      ...
      if (typeof on22 === "function") {
        ...
        on22 = on22(new Proxy(this.config.table[Table.Symbol.Columns], new SelectionProxyHandler({ sqlAliasedBehavior: "sql", sqlBehavior: "sql" })), from && new Proxy(from, new SelectionProxyHandler({ sqlAliasedBehavior: "sql", sqlBehavior: "sql" })));
      }
      this.config.joins.push({ on: on22, table: table3, joinType, alias: tableName });
      return this;
    };
...
var RelationalQueryBuilder = class {
  ...
  findMany(config22) {
    return this.mode === "sync" ? new SQLiteSyncRelationalQuery(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, config22 ? config22 : {}, "many") : new SQLiteRelationalQuery(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, config22 ? config22 : {}, "many");
  }
  findFirst(config22) {
    return this.mode === "sync" ? new SQLiteSyncRelationalQuery(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, config22 ? { ...config22, limit: 1 } : { limit: 1 }, "first") : new SQLiteRelationalQuery(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, config22 ? { ...config22, limit: 1 } : { limit: 1 }, "first");
  }
};
var SQLiteRelationalQuery = class extends QueryPromise {
  ...
  constructor(fullSchema, schema, tableNamesMap, table3, tableConfig, dialect, session, config22, mode) {
    super();
    this.fullSchema = fullSchema;
    this.schema = schema;
    this.tableNamesMap = tableNamesMap;
...
var BaseSQLiteDatabase = class {
  ...
  transaction(transaction, config22) {
    return this.session.transaction(transaction, config22);
  }
};
var Cache = class {
  static {
...
var DefaultLogger = class {
  ...
  writer;
  constructor(config22) {
    this.writer = config22?.writer ?? new ConsoleLogWriter();
  }
...
var SQLiteD1Session = class extends SQLiteSession {
  ...
  async transaction(transaction, config22) {
    const tx = new D1Transaction("async", this.dialect, this, this.schema);
    await this.run(sql.raw(`begin${config22?.behavior ? " " + config22.behavior : ""}`));
    try {
...
function drizzle(client2, config22 = {}) {
  const dialect = new SQLiteAsyncDialect({ casing: config22.casing });
  let logger;
  if (config22.logger === true) {
    logger = new DefaultLogger();
  } else if (config22.logger !== false) {
    logger = config22.logger;
  }
  let schema;
  if (config22.schema) {
    const tablesConfig = extractTablesRelationalConfig(config22.schema, createTableRelationsHelpers);
    schema = {
      fullSchema: config22.schema,
      schema: tablesConfig.tables,
      tableNamesMap: tablesConfig.tableNamesMap
    };
  }
  const session = new SQLiteD1Session(client2, dialect, schema, { logger, cache: config22.cache });
  const db = new DrizzleD1Database("async", dialect, session, schema);
  db.$client = client2;
  db.$cache = config22.cache;
  if (db.$cache) {
    db.$cache["invalidate"] = config22.cache?.onMutate;
  }
  return db;
}
...
async function requireAuth(request) {
  ...
  return client.verify(subject, authToken, { refresh }).then((res) => {
...
__name2(requestToCookie, "requestToCookie");
...
async function PUT2(params) {
  ...
  try {
    const db = drizzle(env22.PROJECT_DB);
...
__name(DELETE2, "DELETE2");
__name2(DELETE2, "DELETE");
...
__name2(paramsFromURL, "paramsFromURL");
async function WrapRequestHandler(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL(new URL(context2.request.url)) : parseData(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
...
__name2(WrapRequestHandler, "WrapRequestHandler");
...
async function GET2(params) {
  ...
  const db = drizzle(env22.PROJECT_DB);
  const template = await db.select().from(emailTemplatesTable).where(eq(emailTemplatesTable.name, params.name)).limit(1).get();
  if (!template)
    return {
      success: false,
...
async function PUT3(params) {
  ...
  try {
    const db = drizzle(env22.PROJECT_DB);
    const existing = await db.select().from(emailTemplatesTable).where(eq(emailTemplatesTable.name, params.name)).limit(1).get();
    if (!existing) {
      return {
        success: false,
        error: "Template not found"
    ...
    await db.update(emailTemplatesTable).set(updateData).where(eq(emailTemplatesTable.name, params.name));
    const updated = await db.select().from(emailTemplatesTable).where(eq(emailTemplatesTable.name, params.name)).limit(1).get();
    return {
      success: true,
      data: updated
    };
...
async function DELETE3(params) {
  ...
  try {
    ...
    await db.delete(emailTemplatesTable).where(eq(emailTemplatesTable.name, params.name));
    return {
      success: true
    };
  } catch (err) {
...
__name(DELETE3, "DELETE3");
__name2(DELETE3, "DELETE");
...
__name(parseData2, "parseData2");
__name2(parseData2, "parseData");
function paramsFromURL2(url) {
  const params = url.searchParams.entries().toArray().map(([_, v]) => v);
  return params.map((param) => JSON.parse(decodeURIComponent(param)));
}
__name(paramsFromURL2, "paramsFromURL2");
__name2(paramsFromURL2, "paramsFromURL");
async function WrapRequestHandler2(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL2(new URL(context2.request.url)) : parseData2(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
  const missingProps = endpoint.length - parsedData.length;
  for (let i = 0; i < missingProps; i++) {
    parsedData.push(void 0);
  }
...
__name(WrapRequestHandler2, "WrapRequestHandler2");
__name2(WrapRequestHandler2, "WrapRequestHandler");
...
__name(DELETE4, "DELETE4");
__name2(DELETE4, "DELETE");
...
__name(parseData3, "parseData3");
__name2(parseData3, "parseData");
function paramsFromURL3(url) {
  const params = url.searchParams.entries().toArray().map(([_, v]) => v);
  return params.map((param) => JSON.parse(decodeURIComponent(param)));
}
__name(paramsFromURL3, "paramsFromURL3");
__name2(paramsFromURL3, "paramsFromURL");
async function WrapRequestHandler3(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL3(new URL(context2.request.url)) : parseData3(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
  const missingProps = endpoint.length - parsedData.length;
  for (let i = 0; i < missingProps; i++) {
    parsedData.push(void 0);
  }
...
__name(WrapRequestHandler3, "WrapRequestHandler3");
__name2(WrapRequestHandler3, "WrapRequestHandler");
var onRequest3 = /* @__PURE__ */ __name2(async (context2) => {
  const method = context2.request.method;
  const options = {
...
var AuthManager = class {
  ...
  async verify(request) {
    ...
    const verified = await this.client.verify(this.props.verify.subjects, cookies.get("access_token"), {
      ...
      fetch: /* @__PURE__ */ __name2((body, init) => {
        const header = new Headers(init?.headers || {});
...
var onRequest4 = /* @__PURE__ */ __name2((ctx) => {
...
var onRequest5 = /* @__PURE__ */ __name2((ctx) => {
  return new AuthManager({
    issuer: ctx.env.PUBLIC_ISSUER,
    client_id: ctx.env.PUBLIC_CLIENT_ID,
    client,
...
__name(parseData4, "parseData4");
__name2(parseData4, "parseData");
function paramsFromURL4(url) {
  const params = url.searchParams.entries().toArray().map(([_, v]) => v);
  return params.map((param) => JSON.parse(decodeURIComponent(param)));
}
__name(paramsFromURL4, "paramsFromURL4");
__name2(paramsFromURL4, "paramsFromURL");
async function WrapRequestHandler4(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL4(new URL(context2.request.url)) : parseData4(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
  const missingProps = endpoint.length - parsedData.length;
  for (let i = 0; i < missingProps; i++) {
    parsedData.push(void 0);
  }
...
__name(WrapRequestHandler4, "WrapRequestHandler4");
__name2(WrapRequestHandler4, "WrapRequestHandler");
var onRequest6 = /* @__PURE__ */ __name2(async (context2) => {
  const method = context2.request.method;
  const options = {
...
__name2(isClientIdValid, "isClientIdValid");
...
__name(parseData5, "parseData5");
__name2(parseData5, "parseData");
function paramsFromURL5(url) {
  const params = url.searchParams.entries().toArray().map(([_, v]) => v);
  return params.map((param) => JSON.parse(decodeURIComponent(param)));
}
__name(paramsFromURL5, "paramsFromURL5");
__name2(paramsFromURL5, "paramsFromURL");
async function WrapRequestHandler5(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL5(new URL(context2.request.url)) : parseData5(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
  const missingProps = endpoint.length - parsedData.length;
  for (let i = 0; i < missingProps; i++) {
    parsedData.push(void 0);
  }
...
__name(WrapRequestHandler5, "WrapRequestHandler5");
__name2(WrapRequestHandler5, "WrapRequestHandler");
var onRequest7 = /* @__PURE__ */ __name2(async (context2) => {
  const method = context2.request.method;
  const options = {
...
__name(parseData6, "parseData6");
__name2(parseData6, "parseData");
function paramsFromURL6(url) {
  const params = url.searchParams.entries().toArray().map(([_, v]) => v);
  return params.map((param) => JSON.parse(decodeURIComponent(param)));
}
__name(paramsFromURL6, "paramsFromURL6");
__name2(paramsFromURL6, "paramsFromURL");
async function WrapRequestHandler6(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL6(new URL(context2.request.url)) : parseData6(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
  const missingProps = endpoint.length - parsedData.length;
  for (let i = 0; i < missingProps; i++) {
    parsedData.push(void 0);
  }
...
__name(WrapRequestHandler6, "WrapRequestHandler6");
__name2(WrapRequestHandler6, "WrapRequestHandler");
var onRequest8 = /* @__PURE__ */ __name2(async (context2) => {
  const method = context2.request.method;
  const options = {
...
__name(parseData7, "parseData7");
__name2(parseData7, "parseData");
function paramsFromURL7(url) {
  const params = url.searchParams.entries().toArray().map(([_, v]) => v);
  return params.map((param) => JSON.parse(decodeURIComponent(param)));
}
__name(paramsFromURL7, "paramsFromURL7");
__name2(paramsFromURL7, "paramsFromURL");
async function WrapRequestHandler7(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL7(new URL(context2.request.url)) : parseData7(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
  const missingProps = endpoint.length - parsedData.length;
  for (let i = 0; i < missingProps; i++) {
    parsedData.push(void 0);
  }
...
__name(WrapRequestHandler7, "WrapRequestHandler7");
__name2(WrapRequestHandler7, "WrapRequestHandler");
var onRequest9 = /* @__PURE__ */ __name2(async (context2) => {
  const method = context2.request.method;
  const options = {
...
__name(parseData8, "parseData8");
__name2(parseData8, "parseData");
function paramsFromURL8(url) {
  const params = url.searchParams.entries().toArray().map(([_, v]) => v);
  return params.map((param) => JSON.parse(decodeURIComponent(param)));
}
__name(paramsFromURL8, "paramsFromURL8");
__name2(paramsFromURL8, "paramsFromURL");
async function WrapRequestHandler8(context2, endpoint) {
  const isServerAction = context2.request.headers.get("x-server-action") === "true";
  if (!isServerAction) {
    return new Response("Not Found", { status: 404 });
  }
  const parsedData = context2.request.method === "GET" || context2.request.method === "HEAD" ? paramsFromURL8(new URL(context2.request.url)) : parseData8(context2.request.headers.get("content-type") ? await context2.request.formData() : void 0);
  const missingProps = endpoint.length - parsedData.length;
  for (let i = 0; i < missingProps; i++) {
    parsedData.push(void 0);
  }
...
__name(WrapRequestHandler8, "WrapRequestHandler8");
__name2(WrapRequestHandler8, "WrapRequestHandler");
var onRequest10 = /* @__PURE__ */ __name2(async (context2) => {
  const method = context2.request.method;
  const options = {
...
// .wrangler/tmp/bundle-sNMCIF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-sNMCIF/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4492528550132633.js.map
