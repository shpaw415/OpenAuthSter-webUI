...
var Process = class _Process2 extends EventEmitter {
	...
	constructor(impl) {
		...
		for (const prop of [
			...Object.getOwnPropertyNames(_Process2.prototype),
...
var _performanceNow2 = globalThis.performance?.now
	? globalThis.performance.now.bind(globalThis.performance)
	: () => Date.now() - _timeOrigin2;
var nodeTiming2 = {
	name: "node",
	entryType: "node",
	startTime: 0,
...
var PerformanceMark3 = class PerformanceMark22 extends PerformanceEntry2 {
	static {
		__name(PerformanceMark22, "PerformanceMark2");
	}
	static {
		__name2(PerformanceMark22, "PerformanceMark");
	}
	entryType = "mark";
	constructor() {
		super(...arguments);
...
var Performance2 = class {
	...
	addEventListener(type, listener, options) {
		throw /* @__PURE__ */ createNotImplementedError2(
...
var createTask =
	_console?.createTask ?? /* @__PURE__ */ notImplemented2("console.createTask");
...
var hrtime4 = /* @__PURE__ */ Object.assign(
	/* @__PURE__ */ __name2(
...
var Process2 = class _Process extends EventEmitter2 {
	...
	// --- attached interfaces ---
	permission = {
		has: /* @__PURE__ */ notImplemented2("process.permission.has"),
	};
	report = {
		directory: "",
		filename: "",
	...
	finalization = {
		...
		unregister: /* @__PURE__ */ notImplemented2(
			"process.finalization.unregister",
		),
		registerBeforeExit: /* @__PURE__ */ notImplemented2(
			"process.finalization.registerBeforeExit",
		),
	};
	memoryUsage = Object.assign(
...
var isCryptoKey = /* @__PURE__ */ __name2(
...
__export(exports_errors, {
	...
	JWTClaimValidationFailed: /* @__PURE__ */ __name2(
		() => JWTClaimValidationFailed,
		"JWTClaimValidationFailed",
	),
	JWSSignatureVerificationFailed: /* @__PURE__ */ __name2(
		() => JWSSignatureVerificationFailed,
		"JWSSignatureVerificationFailed",
	),
	JWSInvalid: /* @__PURE__ */ __name2(() => JWSInvalid, "JWSInvalid"),
	JWKSTimeout: /* @__PURE__ */ __name2(() => JWKSTimeout, "JWKSTimeout"),
	JWKSNoMatchingKey: /* @__PURE__ */ __name2(
		() => JWKSNoMatchingKey,
		"JWKSNoMatchingKey",
	),
	JWKSMultipleMatchingKeys: /* @__PURE__ */ __name2(
	...
	JWEDecryptionFailed: /* @__PURE__ */ __name2(
		() => JWEDecryptionFailed,
		"JWEDecryptionFailed",
	),
	JOSENotSupported: /* @__PURE__ */ __name2(
		() => JOSENotSupported,
		"JOSENotSupported",
	),
	JOSEError: /* @__PURE__ */ __name2(() => JOSEError, "JOSEError"),
	JOSEAlgNotAllowed: /* @__PURE__ */ __name2(
		() => JOSEAlgNotAllowed,
		"JOSEAlgNotAllowed",
	),
});
...
var exportKeyValue = /* @__PURE__ */ __name2(
	(k) => decode(k),
	"exportKeyValue",
);
var privCache;
...
var importAndCache = /* @__PURE__ */ __name2(
...
var symmetricTypeCheck = /* @__PURE__ */ __name2(
...
var asymmetricTypeCheck = /* @__PURE__ */ __name2(
	(alg, key, usage, allowJwk) => {
		if (allowJwk && isJWK(key)) {
			switch (usage) {
				case "sign":
...
var epoch_default = /* @__PURE__ */ __name2(
...
var normalizeTyp = /* @__PURE__ */ __name2(
...
var jwt_claims_set_default = /* @__PURE__ */ __name2(
...
function createLocalJWKSet(jwks) {
	...
	const localJWKSet = /* @__PURE__ */ __name2(
		...
		return mergeQueries(
			chunks.map((chunk) => {
				...
				if (is(chunk, Param)) {
					...
					if (inlineParams) {
						return {
							sql: this.mapInlineParam(mappedValue, config22),
							params: [],
						};
					}
					let typings = ["none"];
...
var noopDecoder = {
	mapFromDriverValue: /* @__PURE__ */ __name2(
		(value) => value,
		"mapFromDriverValue",
	),
};
var noopEncoder = {
	mapToDriverValue: /* @__PURE__ */ __name2(
		(value) => value,
		"mapToDriverValue",
	),
};
...
var SelectionProxyHandler = class _SelectionProxyHandler {
	static {
		__name(_SelectionProxyHandler, "_SelectionProxyHandler");
	}
	static {
		__name2(_SelectionProxyHandler, "SelectionProxyHandler");
	}
...
var DrizzleQueryError = class _DrizzleQueryError extends Error {
	static {
		__name(_DrizzleQueryError, "_DrizzleQueryError");
	}
	static {
		__name2(_DrizzleQueryError, "DrizzleQueryError");
	}
...
function createOne(sourceTable) {
	return /* @__PURE__ */ __name2(
		/* @__PURE__ */ __name(function one(table3, config22) {
			return new One(
				sourceTable,
				table3,
				config22,
				config22?.fields.reduce((res, f) => res && f.notNull, true) ?? false,
			);
		}, "one"),
		"one",
	);
...
function createMany(sourceTable) {
	return /* @__PURE__ */ __name2(
		/* @__PURE__ */ __name(function many(referencedTable, config22) {
...
var SQLiteDialect = class {
	...
	buildRelationalQuery({
		...
		if (config22 === true) {
			...
			if (config22.where) {
				const whereSql =
					typeof config22.where === "function"
						? config22.where(aliasedColumns, getOperators())
						: config22.where;
			...
			if (config22.columns) {
				...
				if (selectedColumns.length > 0) {
					selectedColumns = isIncludeMode
						? selectedColumns.filter((c) => config22.columns?.[c] === true)
			...
			if (config22.with) {
				selectedRelations = Object.entries(config22.with)
			...
			if (config22.extras) {
				extras =
					typeof config22.extras === "function"
						? config22.extras(aliasedColumns, { sql })
						: config22.extras;
			...
			let orderByOrig =
				typeof config22.orderBy === "function"
					? config22.orderBy(aliasedColumns, getOrderByOperators())
					: (config22.orderBy ?? []);
	...
	migrate(migrations, session, config22) {
		const migrationsTable =
			config22 === void 0
				...
				: typeof config22 === "string"
					? "__drizzle_migrations"
					: (config22.migrationsTable ?? "__drizzle_migrations");
	...
	$withCache(config22) {
		this.cacheConfig =
			config22 === void 0
				...
				: config22 === false
					? { enable: false }
					: { enable: true, autoInvalidate: true, ...config22 };
		return this;
	}
	prepare() {
		return this._prepare(false);
...
var SQLiteInsertBase = class extends QueryPromise {
	...
	onConflictDoNothing(config22 = {}) {
		...
		if (config22.target === void 0) {
			...
			const targetSql = Array.isArray(config22.target)
				? sql`${config22.target}`
				: sql`${[config22.target]}`;
	...
	onConflictDoUpdate(config22) {
		...
		const targetWhereSql = config22.targetWhere
			? sql` where ${config22.targetWhere}`
			: void 0;
		const setWhereSql = config22.setWhere
			? sql` where ${config22.setWhere}`
			: void 0;
		const targetSql = Array.isArray(config22.target)
			? sql`${config22.target}`
			: sql`${[config22.target]}`;
		const setSql = this.dialect.buildUpdateSet(
			this.config.table,
			mapUpdateSet(this.config.table, config22.set),
		);
		this.config.onConflict.push(
...
var SQLiteCountBuilder = class _SQLiteCountBuilder extends SQL {
	static {
		__name(_SQLiteCountBuilder, "_SQLiteCountBuilder");
	}
	static {
		__name2(_SQLiteCountBuilder, "SQLiteCountBuilder");
	}
	constructor(params) {
		super(
	...
	findFirst(config22) {
		return this.mode === "sync"
			? new SQLiteSyncRelationalQuery(
					...
					this.dialect,
					this.session,
					config22 ? { ...config22, limit: 1 } : { limit: 1 },
					"first",
				)
			: new SQLiteRelationalQuery(
					this.fullSchema,
...
var BaseSQLiteDatabase = class {
	...
	constructor(resultKind, dialect, session, schema) {
		...
		this.$cache = {
			invalidate: /* @__PURE__ */ __name2(async (_params) => {}, "invalidate"),
		};
	}
...
var SQLiteD1Session = class extends SQLiteSession {
	...
	async transaction(transaction, config22) {
		...
		await this.run(
			sql.raw(`begin${config22?.behavior ? " " + config22.behavior : ""}`),
		);
		try {
...
var D1Transaction = class _D1Transaction extends SQLiteTransaction {
	static {
		__name(_D1Transaction, "_D1Transaction");
	}
	static {
		__name2(_D1Transaction, "D1Transaction");
	}
...
var drainBody = /* @__PURE__ */ __name2(
	async (request, env22, _ctx, middlewareCtx) => {
		try {
...
function wrapExportedHandler(worker) {
	...
	const fetchDispatcher = /* @__PURE__ */ __name2((request, env22, ctx) => {
...
var drainBody2 = /* @__PURE__ */ __name(
	async (request, env3, _ctx, middlewareCtx) => {
		try {
...
function wrapExportedHandler2(worker) {
	...
	const fetchDispatcher = /* @__PURE__ */ __name((request, env3, ctx) => {
		if (worker.fetch === void 0) {
			throw new Error("Handler does not export a fetch() function.");
		}
